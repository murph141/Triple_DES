...
COMPONENT_FILES	:= expansion.sv s_box_wrapper.sv PBox.sv s_box1.sv s_box2.sv s_box3.sv s_box4.sv s_box5.sv s_box6.sv s_box7.sv s_box8.sv roundkey.sv flex_counter.sv DES_round_wrapper.sv DES_block.sv triple_DES_block.sv AHBLiteSlaveController.sv TopLevel.sv DefaultSlave.sv Decoder.sv Multiplexer.sv
